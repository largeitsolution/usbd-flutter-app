...
class AppConfig {
  static String copyright_text =
      "@ USBD shopping " + this_year; //this shows in the splash screen
  static String app_name = "USBD shopping"; //this shows in the splash screen
  ...
  static const DOMAIN_PATH =
      "www.usbdshopping.com"; // directly inside the public folder
